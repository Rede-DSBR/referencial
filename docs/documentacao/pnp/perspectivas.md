...
Conforme planejamento da Setec/MEC, o escopo de indicadores será ampliado aproveitando a flexibilidade do [Produto de Dados CCV]({{site.baseUrl}}/guiapnp/documentacao/ccv/produto_de_dados "Produto de Dados"). Novos indicadores – como os relacionados à infraestrutura física, equipamentos e bens, às ações de política estudantil, à educação do campo, aos programas e projetos de sustentabilidade ambiental e à internacionalização – serão desenvolvidos em diálogo com o Conselho Nacional das Instituições da Rede Federal de Educação Profissional, Científica e Tecnológica (Conif) e gradativamente incorporados à Plataforma Nilo Peçanha.