...
<table border="1" cellspacing="0" cellpadding="5" style="border-collapse: collapse; width: 100%;">
  ...
  <tbody>
    ...
    <tr>
      <td><strong>Meta:</strong> 3,6 – Meta 13 prevista na Lei 13.005/2014.</td>
    ...
    <tr>
      <td colspan="2">
        ...
        <p style="text-align: center; margin: 10px 0;">
          <em>
            ITCD = (DG + (DA &times; 2) + (DE &times; 3) + (DM &times; 4) + (DD &times; 5)) / TDE
          </em>
        </p>
      </td>
    </tr>
    ...
    <tr>
      <td colspan="2">
     <strong>[(DG) + (DA &times; 2) + (DE &times; 3) + (DM &times; 4) + (DD &times; 5)]- Docentes efetivos segregados e ponderados considerando a maior titulação</strong><br><br>
        <strong>Fonte:</strong> PNP (SIAPE / CCV).<br><br>
        <strong>Definição:</strong> Número de Docentes efetivos <em>Graduados</em> (DG) multiplicado pelo “peso” 1, somado à quantidade de Docentes efetivos
        <em>Aperfeiçoados</em> (DA) multiplicado pelo “peso” 2, somado à quantidade de Docentes efetivos
        <em>Especialistas</em> (DE) multiplicado pelo “peso” 3, somado à quantidade de Docentes efetivos
        <em>Mestres</em> (DM) multiplicado pelo “peso” 4, somado à quantidade de Docentes efetivos
        <em>Doutores</em> (DD) multiplicado pelo “peso” 5.
        <br><br>
  </tbody>
</table>
