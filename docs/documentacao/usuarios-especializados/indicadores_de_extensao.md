...
<p>&nbsp;</p>
<h3 style="color: #004080;">
Percentual de ações de extensão destinadas à inclusão de população vulnerável (EXINC)
</h3>
<table>
  <tr>
    <th colspan="2"><strong><i>
...
<p>&nbsp;</p>
<h3 style="color: #004080;">
Percentual de estudantes envolvidos em ações de extensão (EXES)
</h3>
<table>
  <tr>
    <th colspan="2"><strong><i>
  ...
  <tr>
    <td colspan="2">
      Mensura o percentual de estudantes envolvidos em ações de extensão, independente da modalidade (Projeto, Programa, Evento, Curso e Prestação de Serviço).
    </td>
  </tr>
  <tr>
    <td colspan="2">
