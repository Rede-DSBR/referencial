...
A disseminação de dados é realizada por meio da criação de três produtos principais: [Produto Visual]({{site.baseUrl}}/documentacao/odi/produto_visual "Produto Visual"), [Produto Semântico]({{site.baseUrl}}/documentacao/odi/produto_semantico "Produto Semântico") e [Produto de Dados]({{site.baseUrl}}/documentacao/odi/produto_de_dados "Produto de Dados"). Esses produtos são distribuídos por meio do painel interativo da PNP, oferecendo uma interface intuitiva para acessar os dados em formatos gráficos e tabulares.
